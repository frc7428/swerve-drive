...
public class SwerveModule {
   ...
   */
  public SwerveModule(
      final int driveMotorChannel, final int turningMotorChannel, final int[] driveEncoderPorts,
      final int[] turningEncoderPorts, final boolean driveEncoderReversed, final boolean turningEncoderReversed) {
